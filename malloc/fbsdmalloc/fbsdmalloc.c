...
struct pginfo {
    ...
    struct pginfo	*page;	/* Pointer to the page */
...
static unsigned malloc_cache = 2;
...
/* always realloc ?  */
static int malloc_realloc = 0;

/* pass the kernel a hint on free pages ?  */
static int malloc_hint = 0;

/* xmalloc behaviour ?  */
static int malloc_xmalloc = 0;

/* sysv behaviour for malloc(0) ?  */
static int malloc_sysv = 0;
...
#   ifndef linux
    /***HGW this was #ifed by me because linux does not support madvise */
    if (malloc_hint)
